...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const data = { name, email, query, phone };
  ...
  return (
    <>
      ...
      <section className="bg-slate-100">
        <div className="px-6 flex flex-col items-center py-12">
          <h1 className="text-4xl font-medium">Contact Us</h1>
          <div className="mt-8 lg:w-1/2 lg:mx-auto">
            <div className="w-full px-8 py-10 overflow-hidden mx-auto items-center rounded-lg shadow-2xl bg-gray-900  shadow-black">
                    ...
                    <div className="flex my-4 w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md ">
                      ...
                      <div className="px-4 py-2 -mx-3">
                        <div className="mx-3">
                          ...
                          <p className="text-sm text-gray-600 ">{message[0]}</p>
                        </div>
                      </div>
                    </div>
                  </>
