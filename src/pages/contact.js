        ...
        <div className="container px-6 py-12 mx-auto">
          <div className="lg:flex lg:items-center lg:-mx-6">
            <div className="lg:w-1/2 lg:mx-6">
              <h1 className="text-4xl font-semibold capitalize text-gray-700 lg:text-3xl">
                Contact us
              </h1>
              ...
              <div className="mt-6 space-y-8 md:mt-8">
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 truncate w-72 text-gray-800">
              ...
              <div className="mt-6 w-80 md:mt-8">
                ...
                <div className="flex mt-4 -mx-1.5 ">
                  <a
                    className="mx-1.5  text-gray-400 transition-colors duration-300 transform hover:text-blue-400"
                    href="#"
                  >
                    <svg
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div className="w-full px-8 py-10 mx-auto overflow-hidden rounded-lg shadow-2xl bg-gray-900 lg:max-w-xl shadow-black">
